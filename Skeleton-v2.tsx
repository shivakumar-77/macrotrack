...
{/* Hero card — matches the real daily-summary card: big ring + 4 mini rings */}
<div className="card" style={{ marginBottom: 16, padding: '22px 20px 18px' }}>
<div style={{ display: 'flex', justifyContent: 'center', marginBottom: 24 }}>
<Skeleton width="188px" height={188} rounded />
</div>
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 6 }}>
{[0,1,2,3].map(i => (
<div key={i} style={{ display: 'flex', justifyContent: 'center' }}>
<Skeleton width="62px" height={62} rounded />
</div>
        ))}
</div>
</div>
