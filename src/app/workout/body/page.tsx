...
const MUSCLE_GROUPS = [
  ...
  { id:'Shoulders', label:'Shoulders', emoji:'💪', color:'#3b82f6', desc:'Front, side & rear delts', front:true,
    muscles:['Anterior Deltoid','Lateral Deltoid','Posterior Deltoid'] },
  { id:'Arms',      label:'Arms',      emoji:'💪', color:'#8b5cf6', desc:'Biceps, triceps, forearms', front:true,
    muscles:['Biceps Brachii','Brachialis','Triceps Brachii','Forearms'] },
  { id:'Core',      label:'Core',      emoji:'🔥', color:'#10b981', desc:'Abs, obliques, lower back', front:true,
    muscles:['Rectus Abdominis','Obliques','Transverse Abdominis','Erector Spinae'] },
  { id:'Legs',      label:'Legs',      emoji:'🦵', color:'#f59e0b', desc:'Quads, hamstrings, glutes, calves', front:true,
    muscles:['Quadriceps','Hamstrings','Glutes','Gastrocnemius','Soleus'] },
  { id:'Back',      label:'Back',      emoji:'🏋️', color:'#ef4444', desc:'Lats, traps, rhomboids', front:false,
    muscles:['Latissimus Dorsi','Trapezius','Rhomboids','Erector Spinae'] },
  { id:'Full Body', label:'Full Body', emoji:'⚡', color:'#0ea5e9', desc:'Olympic & compound movements', front:true,
    muscles:['All major muscle groups'] },
  { id:'Cardio',    label:'Cardio',    emoji:'🏃', color:'#ec4899', desc:'Cardiovascular training', front:true,
