...
const items = [
  ...
  { href:'/weight', label:'Weight', icon:<svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2C8.5 2 6 4 6 7c0 2 1 3.5 2.5 4.5L7 22h10l-1.5-10.5C17 10.5 18 9 18 7c0-3-2.5-5-6-5z"/></svg> },
