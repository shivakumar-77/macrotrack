...
const items = [
  ...
  { href:'/weight',    label:'Weight', icon:<svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18M3 12h18M3 18h18"/><path d="M8 6V4a2 2 0 014 0v2M12 12v4"/></svg> },
